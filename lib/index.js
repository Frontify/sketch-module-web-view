...
function WebUI (context, frameLocation, options) {
  ...
  panel.setStyleMask(options.styleMask || (
    ...
    : (NSTexturedBackgroundWindowMask | NSClosableWindowMask | NSFullSizeContentViewWindowMask)
  ))
  ...
  context.document.documentWindow().addChildWindow_ordered(panel, NSWindowAbove)
